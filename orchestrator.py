...
class OrchestratorAgent(BaseAgent):
    def __init__(self):
        super().__init__(
            name = "Orchestrator",
            instructions="""Cordinate the recruitment workflow and the delegate tasks to specialized agents.
            Ensure proper flow of the information between extraction, analysis, screening and recommendation phase.
    ...
    async def process_application(self, resume_data: Dict[str, Any]) ->Dict[str, Any]:
        ...
        try:
            ...
            workflow_context.update(
                {
                    "analysis_results": analysis_results, "currentstage": "matching_jobs"
                }
            )
            ...
            workflow_context.update(
                {
                    "final_recommendation": final_recommendation, "status": "complete"
                }
            )
